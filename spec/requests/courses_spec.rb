...
RSpec.describe "Courses", type: :request do
  ...
  describe "POST /admin/course" do
    ...
    context "with valid parameters" do
      it "creates a new course and redirects" do
        expect {
          post admin_courses_path, params: { course: { cnumber: 411, cname: "Algorithms", ccode: "CSCE", credit_hours: 3 } }
  ...
  describe "PATCH /admin/courses#update" do
    ...
    it "updates and redirects" do
        patch admin_course_path(course), params: { course: { cnumber: 400, cname: "Updated Course Name", ccode: "CSCE", credit_hours: 3, description: 'a', lab_hours: 0, lecture_hours: 0 } }
